"""
This project is based on https://github.com/omkarkshet/Diabetes-Prediction-Using-Machine-Learning-Techniques. We modified the code to fit our needs.
...
If you have any question when running the app, please follow the instructions below.
